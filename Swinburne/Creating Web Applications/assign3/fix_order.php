<?php
	...
	if (!isset($_SESSION["in_process_order_php"])) {
		...
		unset($_SESSION["in_process_order_php"]);
		$_SESSION["in_fix_order_php"] = true;
	}
...
<head>
	...
	<meta name="description" content="Assignment 3: Laptop and Computer Purchase Website - Fix order" />
	<meta name="keywords" content="Assignment 3, Laptop, Computer, Purchase, Fix order" />
	<meta name="author" content="Thanh An Nguyen" />
	<title>Fix the form</title>
...
<body>
	...
	<h1 class="content_header">Fixing the form</h1>
	<hr />

	<h2 id="fix_order_form_header">There are some things you need to fix</h2>
	<h3 id="fix_order_form_header">Please check the inputs carefully before submitting the form:</h3>
	<hr />

	<!-- Fix order form. Linked to the PHP page -->
	<form method="post" action="process_order.php" id="fix_order_form" novalidate="novalidate">
		<!-- First name -->
		<label for="first_name">First name</label> 
		<?php
		echo "<p class='fix_order_error_red'>",$_SESSION["fix_first_name"],"</p>";
		echo '<input type="text" name= "first_name" id="first_name" required="required" maxlength="25" size="25" placeholder="Maximum 25 letters" ', $_SESSION["first_name"], '/>';
		?>
		
		<!-- Last name -->
		<label for="last_name">Last name</label> 
		<?php
		echo "<p class='fix_order_error_red'>",$_SESSION["fix_last_name"],"</p>";
		?>
		...
		<?php
		echo "<p class='fix_order_error_red'>",$_SESSION["fix_email_address"],"</p>";
		?>
		...
		<fieldset>
			...
			<?php
			echo "<p class='fix_order_error_red'>",$_SESSION["fix_street_address"],"</p>";
			?> 
			...
			<?php
			echo "<p class='fix_order_error_red'>",$_SESSION["fix_suburb_town"],"</p>";
			?> 
			...
			<?php
			echo "<p class='fix_order_error_red'>",$_SESSION["fix_state"],"</p>";
			?>
			...
			<?php
			echo "<p class='fix_order_error_red'>",$_SESSION["fix_postcode"],"</p>";
			?>
		...
		<?php
		echo "<p class='fix_order_error_red'>",$_SESSION["fix_phone_number"],"</p>";
		?>
		...
		<fieldset id="preferred_contact">
			...
			<?php
			echo "<p class='fix_order_error_red'>",$_SESSION["fix_preferred_contact"],"</p>";
			?>
		...
		<figure id="fix_order_product_figure">
			<!-- The product image -->
			<img src="images/applelaptop.jpg" alt="Product picture" width="260" height="163" id="fix_order_product_img">
			<figcaption id="fix_order_product_figcaption"> </figcaption>
		</figure>
		<!-- Choose the laptop -->
		<label for="choose_product">Choose your laptop product: </label>
		<?php
		echo "<p class='fix_order_error_red'>",$_SESSION["fix_choose_product"],"</p>";
		?>
		...
		<?php
		echo "<p class='fix_order_error_red'>",$_SESSION["fix_quantity"],"</p>";
		?>
		...
		<fieldset>
			...
			<fieldset id="memory">
				...
				<?php
				echo "<p class='fix_order_error_red'>",$_SESSION["fix_memory"],"</p>";
				?>
			...
			<fieldset id="storage">
				...
				<?php
				echo "<p class='fix_order_error_red'>",$_SESSION["fix_storage"],"</p>";
				?>
				<div class="tick_box">
			...
			<fieldset id="storage_device">
				...
				<?php
				echo "<p class='fix_order_error_red'>",$_SESSION["fix_storage_device"],"</p>";
				?>
				<div class="tick_box">
			...
			<fieldset id="OS">
				...
				<?php
				echo "<p class='fix_order_error_red'>",$_SESSION["fix_OS"],"</p>";
				?>
				<div class="tick_box">
		...
		<fieldset>
			...
			<?php
			echo "<p class='fix_order_error_red'>",$_SESSION["fix_credit_card_type"],"</p>";
			?>
			...
			<?php
			echo "<p class='fix_order_error_red'>",$_SESSION["fix_credit_card_name"],"</p>";
			?>
			...
			<?php
			echo "<p class='fix_order_error_red'>",$_SESSION["fix_credit_card_number"],"</p>";
			?>
			...
			<?php
			echo "<p class='fix_order_error_red'>",$_SESSION["fix_credit_card_expiry_date"],"</p>";
			?>
			...
			<?php
			echo "<p class='fix_order_error_red'>",$_SESSION["fix_credit_card_verification_value"],"</p>";
			?>
			<input name="credit_card_verification_value" type="text" id="credit_card_verification_value" placeholder="CVV" size="25"/>
		</fieldset>
		<!-- the buttons -->
		<div id="fix_order_buttons">
			<input type= "submit" name="fix_submit" value="Submit"/>
			<input type= "reset" value="Reset"/>
			<button type="button" id="fix_order_cancelButton">Cancel Order</button>
		</div>
	</form>
