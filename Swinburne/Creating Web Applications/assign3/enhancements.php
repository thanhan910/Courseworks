...
<head>
	...
	<meta name="description" content="Assignment 3: Laptop and Computer Purchase Website - Enhancements 1" />
	<meta name="keywords" content="Assignment 3, Laptop, Computer, Purchase, Enhancements 1" />
...
<body id="enhancements_html">
	...
	<h1 class="content_header">Enhancements</h1>
	<hr />

	<h3 class="content_header">This is the old Enhancement page of Assignment 1.</h3>
	<h4 class="content_header">Please go to <a href="enhancements2.php">enhancements2.php</a> to see the Enhancements for Assignment 2</h4>
	<hr />
	...
	<main>
		...
		<section>
			...
			<ol>
				...
				<li>
					<p>I used the action attribute to lead the user to the lab.php page in case they enter something in the search bar</p>
					<p>HTML:</p>
					<pre>
<code>&lt;form action=&quot;lab.php&quot;&gt;
&lt;!-- Search input --&gt;
...
color: black;
				...
				<li>As you can see, I included the search bar in every page&apos;s top menu: <a href="about.php#">about.php#</a> I also included another one in the Home page, which leads to the product.php page: <a href="index.php">index.php</a></li>
		...
		<section>
			...
			<ol>
				<li>There are no requirements for a hidden product card in the Assignment 1 instructions, but I included it in the product.php page, so that the page can be more fit. If you hover or click on a product card, it will show the full details of the product.</li>
				<li>
...
&lt;/section&gt;
&lt;!-- The product card is also a link to the enquire.php page --&gt;
...
background-color:white;
				...
				<li>You can try the hovering card at the <a href="product.php">product.php</a> page.</li>
				<li>This is able to run on Firefox.</li>
			</ol>
		</section>
...
cursor:pointer;
				...
				<li>In the <a href="about.php">about.php</a> page, if you hover on my image, or on the unit classes in the timetable, you will see them expand by about 1-1.5 times the original size.</li>
				<li>This is able to run on Firefox.</li>
			</ol>
		</section>
...
list-style-type: &quot;\2713.  &quot;; /*Add . and space to it to make it look nicer*/
				...
				<li>Your can see it in the product-table: <a href="product.php#product-table">product.php#product-table</a>.</li>
				<li>This is able to run on Firefox.</li>
			</ol>
		</section>
...
/* text-decoration: none; */ /* this was already declared in * */
				...
				<li>Your can see the back to top button under every webpage, for example: <a href="enhancements.php#backtotop">enhancements.php#backtotop</a>.</li>
				<li>This is able to run on Firefox.</li>
			</ol>
		</section>
...
resize: both;
				...
				<li>Your can see it in the <a href="enhancements.php">enhancements.php</a> page.</li>
				<li>This is able to run on Firefox.</li>
			</ol>
		</section>
		...
		<section>
			...
			<ul>
				<li>
					...
					<ul>
						<li>The back to top button at the footer <a href="enhancements.php#backtotop">enhancements.php#backtoto</a>. Use anchor href.</li>
						<li>The Google color welcome message at the <a href="index.php">index.php</a> home page. Use span with classes for each color.</li>
						<li>The disclaimer that all laptop names in the webpages are fictional. <a href="product.php#backtotop">product.php#backtotop</a>. Reference: <a href="https://en.wikipedia.org/wiki/All_persons_fictitious_disclaimer">https://en.wikipedia.org/wiki/All_persons_fictitious_disclaimer</a>. Use p.</li>
						<li>The table-cells are merged to display the units by their start and end time, and to display their timespan: <a href="about.php#timetable">about.php#timetable</a>. Use rowspan, colspan.</li>
						<li>The header is a link back to the home page: <a href="enhancements.php#hdr">enhancements.php#hdr</a>. Use anchor href.</li>
					</ul>
				</li>
